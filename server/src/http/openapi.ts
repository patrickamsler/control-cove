...
export const openApiDocument = {
  ...
  tags: [
    {
      name: "Devices",
      description: "Configured switches and environment sensors",
    },
  ],
  paths: {
    "/api/switches": {
      get: listEndpoint(
        "List switches",
        "All configured switches with their latest known state.",
        "Switch",
      ),
    },
    "/api/sensors": {
      get: listEndpoint(
        "List sensors",
        "All configured environment sensors with their latest reading.",
        "Sensor",
      ),
    },
  },
